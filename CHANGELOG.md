...
- Close the CLI/Skill upgrade loop: update notices provide ordered CLI upgrade,
  ...
  post-install/post-upgrade step. Skill bumped to `1.11.1`.
...
- README now follows the family-canonical section order and gained an
  "Errors and exit codes" section; the npm package README follows the
  family-canonical rich form.
...
[Unreleased]: https://github.com/angelmsger/confluence-cli/compare/v0.19.0...HEAD
