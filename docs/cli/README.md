...
| Command | Description |
| --- | --- |
| [`confluence-cli skill`](https://angelmsger.github.io/confluence-cli/cli/#confluence-cli-skill) | Install the companion Skill for coding agents (Claude Code, Codex, Grok Build) |
